...
imp_nhanes = read_csv("~/Box/Research/Research projects/SSB tax/sf_nhanes.csv")
yrs = 100
...
delta_ssb = mean(imp_nhanes$ssb_g)*.035274*.027 # ounces/person/day; convert grams to ounces with *.035274,  then  multiply by percent change
